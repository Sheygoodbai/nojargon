...
const ENGLISH_REPLACEMENTS = [
  ...
  [/\balign stakeholders? on\b/gi, "get everyone to agree on"],
  [/\balign on\b/gi, "agree on"],
  [/\bbest practices\b/gi, "common reliable approaches"],
  [/\bbest practice\b/gi, "common reliable approach"],
  [/\bend-to-end plan\b/gi, "plan from start to finish"],
  ...
  [/\bbest practice(s)?\b/gi, "common reliable approach"],
